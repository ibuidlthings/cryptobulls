...
- `initialize` — locks the $BULLS mint into BullBank
...
3. Fill the listing application:
   ...
   - Banner: upload `cryptobulls-web/public/banner.png` (1500×500)
   - Avatar: upload `cryptobulls-web/public/mascot.png` (256×256)
...
4. Click **Claim** → connect **@CTBullsfun** X account when prompted.
